...
def main():
    ...
    for original in source.rglob("*"):
        if original.is_file():
            ...
            checked += 1
    for extra in ([], ["--player"], ["--collaboration"], ["--organizer"]):
    ...
    report = {"version": version, "installer": str(installer), "sha256": digest(installer),
              ...
              "live_registration_unchanged": True, "startup": "passed", "player": "passed", "collaboration": "passed", "categories": "passed", "organizer": "passed"}
